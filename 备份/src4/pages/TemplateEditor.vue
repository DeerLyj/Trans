...
.lab{font-size:14px;opacity:.78;width:34px}
.input{background:#0b1220;color:#e5e7eb;border:1px solid #1f2937;border-radius:10px;padding:10px 12px;width:90%;box-shadow:inset 0 0 0 1px rgba(255,255,255,.02)}
